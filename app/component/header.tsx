...
const Header = () => {
  ...
  return (
    <header className={`${style.backgroundImg} mb-[4rem] py-[6rem]`}>
      <div className={``}>
        <div className={`p-4 md:px-[4rem] max-w-[768px]`}>
          ...
          <h1 className={`text-[#fff] text-[1.5rem] md:text-[2rem] font-[600] leading-4 tracking-[3px] capitalize mb-8 md:leading-[42px] font-[Lora]`}>Memory chest</h1>
          ...
          <div className={`flex`}>
            <span className={`text-[#cfcece] text-[14px] leading-[20px] font-[400]`}>____&nbsp;</span> 
            <p className={`text-[#cfcece] text-[14px] leading-[20px] font-[400] mt-1 capitalize md:text-[1.1rem]`}> Unlocking the treasures of the past.</p>
          </div>
        </div>
      </div>
    </header>
