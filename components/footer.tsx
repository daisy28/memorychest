  ...
  return (
    <footer className={`bg-[#212529] relative top-[92.5px] bottom-0`}>
      <div className={`p-4 py-10 md:px-[4rem] flex flex-col gap-[2rem] md:flex-row md:justify-between md:items-start`}>
        ...
        <div className={`flex gap-4 justify-center flex-col md:justify-start`}>
          <h1 className={`text-[#fff] text-[18px] font-[600] tracking-[2px] leading-[28px] capitalize font-[Lora]`}>Connections</h1>
      ...
      <div className={`flex justify-center items-center bg-[#343a40] p-4 py-8`}><p className={`text-[#e5e5e5] font-[600] text-[14px] leading-[28px] tracking-[2px] font-[Lora]`}> &copy;memorychest&nbsp;{new Date().getFullYear()}</p></div>
    </footer>
  )
}
